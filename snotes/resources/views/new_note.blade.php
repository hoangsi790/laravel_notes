...
{!! Form::open([
    ...
    <div class="col-sm-6 col-md-6 col-lg-6 " style="cursor:default;" >
            ...
            <div class="note_title_wrapper">
                        <h2 class="note_title">
                    <input placeholder="Nhập tiêu đề của ghi chú..." type="text" id="title" name="title" class="form-control" required style="background:none;border:none;outline:none;box-shadow:none;" autocomplete="off">
                    </strong> </h2>
                        <hr>
                    </div>
            <!-- end note title --> 
            ...
            <div class="note_content_wrapper">
                        <textarea rows="8"  placeholder="Nhập nội dung của ghi chú..." id="content" name="content" class="form-control"  style="resize:none; background:none;border:none;outline:none;box-shadow:none;"></textarea>
                    </div>
            <!-- end note content -->
            
            <div class="note_group_wrapper collapse"  id="open_group">
