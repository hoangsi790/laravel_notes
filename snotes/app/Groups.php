...
class Groups extends Model
{
	...
	public function query_groups($user_id,  $paginate, $order_col, $order_value) {
    	 return DB::table($this->table)->select('id', 'title', 'content', 'created_at', 'updated_at', 'user_id', 'background_id')->where('user_id', $user_id)->orderBy($order_col, $order_value)->paginate($paginate);
	}
